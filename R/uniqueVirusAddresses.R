...
#' @format A data frame with 41413 rows and 11 variables:
#' \describe{
...
#'   \item{\code{looped}}{double COLUMN_DESCRIPTION}
#'   \item{\code{neighbors}}{double COLUMN_DESCRIPTION}
#'   \item{\code{income}}{double COLUMN_DESCRIPTION}
#'   \item{\code{label}}{character COLUMN_DESCRIPTION}
#'}
#' @source \url{http://somewhere.important.com/}
"uniqueVirusAddresses"
